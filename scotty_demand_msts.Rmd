...
`Pada chart diatas dapat dilihat bahwa high season terjadi pada pada setiap hari Jumat pukul 17:00 sampai 19:00.` 
...
# write_csv(result_submit,paste(paste(wd,"/data_result/",sep = ""),filename,sep=""))
...
#vis_forecast[c(10,24,168,336,504),]
```
